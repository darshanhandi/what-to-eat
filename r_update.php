...
if (isset($_POST['update'])) {
	...
	{
		$query="UPDATE resturant_owner SET name='$name',address='$address',mobile='$mobile',email='$email',password='$password' WHERE id=$id";
